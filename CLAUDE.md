<!--
  ...
  This CLAUDE.md was adapted from the Propvora project's release-readiness playbook.
  All "Propvora" brand references have been renamed to "Caption Fox" to apply to THIS repo,
  and the webhook header names X-Propvora-Signature / X-Propvora-Token were renamed to
  X-CaptionFox-Signature / X-CaptionFox-Token.
  The release-gating checklists, design-token discipline, and Chrome-MCP audit process below
  are intentionally reused — they are product-agnostic and still apply.
  CAVEATS for anyone applying these rules:
    - Caption Fox is a SOCIAL-MEDIA MARKETING SaaS (Next.js 16 + Supabase + Tailwind),
      NOT a property platform. Ignore any property-domain examples (tenancies, landlords,
      property managers) and apply the same standards to Caption Fox's real sections:
      Studio, Calendar, Campaigns, UGC, Inbox, Analytics, Listening, Links, Settings, Admin.
    - Some benchmark references still point to "/property-manager/home" (a Propvora route).
      Use Caption Fox's equivalent benchmark "/app/home" instead.
...
27.	Confirm cards, panels and containers use Caption Fox design tokens.
28.	Confirm colours, typography, borders, shadows, icons, badges and radii match the Caption Fox premium system.
...
32.	Confirm the page does not visually clash with other Caption Fox sections.
33.	Confirm any required UI upgrade is completed to reach premium release quality.
34.	Confirm any missing shared components are added or replaced with existing Caption Fox primitives.
...
28.	Confirm the sub-tab order is logical and consistent across Caption Fox.
...
32.	Confirm hover, focus, disabled and locked tab states match Caption Fox design tokens.
...
41.	Confirm tab badge colours follow Caption Fox brand/status tokens.
...
54.	Confirm the sub-tab header layout is consistent with the rest of Caption Fox.
...
60.	Confirm cards, tables, boards, timelines, calendars, maps and panels use shared Caption Fox primitives.
...
63.	Confirm typography, icons, badges, buttons, cards, borders, radii and shadows match the Caption Fox premium system.
...
66.	Confirm any missing shared component is added or replaced with the correct Caption Fox primitive.
...
146.	Confirm archive, delete and restore behaviour is consistent with the rest of Caption Fox.
...
237.	Confirm focus states are visible and follow Caption Fox styling.
...
21.	Confirm nested route slugs are clean, predictable and consistent with Caption Fox route naming.
...
42.	Confirm nested tab order is logical and consistent across Caption Fox.
...
46.	Confirm locked, disabled, active, hover and focus states match Caption Fox design tokens.
...
77.	Confirm cards, tables, boards, timelines, calendars, maps, filters, empty states and action bars use shared Caption Fox primitives.
...
83.	Confirm any missing shared component is added or replaced with the correct Caption Fox primitive.
...
171.	Confirm save, cancel, archive, delete, restore and status workflows behave consistently with the rest of Caption Fox.
...
63.	Confirm cards, panels, tables, boards, timelines, calendars and file grids use shared Caption Fox primitives.
64.	Confirm no one-off styling exists for detail tabs unless it has been added to the design system.
65.	Confirm typography, spacing, border radius, shadows, badges, icons and buttons match Caption Fox premium styling.
...
71.	Confirm any missing shared component is added or replaced with the correct Caption Fox primitive.
...
78.	Confirm hover, focus, disabled and locked states match Caption Fox design tokens.
...
202.	Confirm archive, delete and restore actions match the Caption Fox global pattern.
...
27.	Confirm the wizard title is clear and consistent with Caption Fox naming.
...
35.	Confirm the wizard width, borders, padding, cards, sections and footer actions align with Caption Fox shell/design tokens.
36.	Confirm the wizard styling is consistent with benchmark /property-manager/home.
37.	Confirm typography, icons, labels, helper text, buttons, badges, borders, shadows and radii match Caption Fox premium styling.
...
43.	Confirm any missing component is added or replaced with the correct Caption Fox primitive.
...
274.	Confirm visual regression checks compare wizard width, padding, stepper, footer actions, forms and cards against Caption Fox benchmark styling.
________________________________________
...
47.	Confirm AI/Copilot state does not reset unexpectedly while navigating between Caption Fox routes.
...
50.	Confirm AI/Copilot follows Caption Fox premium styling.
...
56.	Confirm AI/Copilot uses Caption Fox brand tokens.
...
59.	Confirm AI-generated action cards use consistent Caption Fox styling.
60.	Confirm AI-generated citation/source cards use consistent Caption Fox styling.
61.	Confirm AI-generated warning/error cards use consistent Caption Fox styling.
...
97.	Confirm visible focus states are consistent with Caption Fox styling.
...
255.	Confirm AI answers include source references/citations to Caption Fox records where appropriate.
...
479.	Confirm AI model/provider failure does not break non-AI Caption Fox pages.
...
18.	Confirm automation entry points are consistent across Caption Fox.
...
71.	Confirm automation UI follows Caption Fox premium styling.
...
79.	Confirm automation UI uses Caption Fox brand tokens.
...
156.	Confirm visible focus states are consistent with Caption Fox styling.
...
193.	Confirm automation templates/recipes are useful to Caption Fox customer stories.
...
•	Two verification paths: simple (sha256(secret) in X-CaptionFox-Signature) and strong (HMAC-SHA256(body, secret))
...
•	Caption Fox → external HTTPS endpoint (enforced https://)
...
•	Optional shared secret → sent as X-CaptionFox-Token header
