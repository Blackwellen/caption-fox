...
export const shellConfigs: Record<ShellSurface, ShellConfig> = {
  creator: campaignConfig('Creator workspace', 'Creator', groups => {
    insert(groups, 'Create', [{ id: 'brand', label: 'Brand & Assets', tabs: ['Brand Kits'] }])
  ...
  supplier: { label: 'Supplier workspace', role: 'Creative supplier', description: 'Development-only supplier workspace shell.', mobile: ['dashboard', 'orders', 'listings', 'messages'], profileLabel: 'Supplier shopfront', groups: [
    ...
    { label: 'Opportunities', items: [{ id: 'requests', label: 'Requests & Opportunities', tabs: ['Open', 'Invited', 'Responded', 'Closed'] }, { id: 'quotes', label: 'Quotes', tabs: ['Drafts', 'Sent', 'Accepted', 'Declined'] }] },
  ...
  admin: { label: 'Platform Admin', role: 'Platform administrator', description: 'Development-only platform operations shell.', mobile: ['dashboard', 'workspaces', 'users', 'support'], profileLabel: 'Admin profile', groups: [
    ...
    { label: 'Marketplace', items: [{ id: 'marketplace', label: 'Marketplace Operations', tabs: ['Suppliers', 'Listings', 'Orders', 'Verification', 'Payouts', 'Disputes'], detailTabs: ['Identity', 'Shopfront', 'Risk', 'Orders', 'Payments', 'Audit'] }] },
    { label: 'Product', items: [{ id: 'billing', label: 'Plans, Billing & Entitlements', tabs: ['Plans', 'Subscriptions', 'Invoices', 'Usage', 'Coupons'] }, { id: 'ai-safety', label: 'Content, AI & Safety', tabs: ['Generation', 'Moderation', 'Prompts', 'Usage', 'Flags'] }, { id: 'connections', label: 'Connections & Webhooks', tabs: ['Providers', 'Tenant connections', 'Webhook events', 'Health'] }] },
    { label: 'Operations', items: [{ id: 'automations', label: 'Automation Operations', tabs: ['Runs', 'Failures', 'Queues', 'Recipes'] }, { id: 'support', label: 'Support & Disputes', tabs: ['Tickets', 'Marketplace disputes', 'Incidents', 'Macros'], detailTabs: ['Conversation', 'Tenant context', 'Evidence', 'Actions', 'Audit'] }] },
