...
/**
 * Route-level error boundary. It catches a failure in any Calendar page without
...
export default function CalendarError({
  ...
  useEffect(() => {
    ...
    console.error('[calendar:boundary]', error.digest ?? error.message)
  }, [error])
  ...
  return (
    <div className="mx-auto w-full max-w-[1280px] px-6 py-12 xl:px-8">
      <div className="rounded-xl border border-slate-200 bg-white px-6 py-12 text-center" role="alert">
        ...
        <h1 className="text-[18px] font-semibold text-slate-900">Something went wrong loading the calendar</h1>
        <p className="mx-auto mt-1.5 max-w-md text-[13px] leading-5 text-slate-500">
          ...
          <span className="font-mono text-slate-700">{error.digest ?? 'CAL-RENDER'}</span>.
        </p>
