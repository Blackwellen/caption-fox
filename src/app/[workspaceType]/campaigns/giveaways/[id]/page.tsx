...
export default function GiveawayDetailPage() {
  ...
  if (!giveaway) {
    return (
      <div className="p-6">
        <EmptyState icon={Gift} title="Giveaway not found" description="This giveaway doesn't exist or you don't have access." action={{ label: 'Back to Giveaways', onClick: () => router.push(`${base}/giveaways`) }} />
      </div>
    )
  }
