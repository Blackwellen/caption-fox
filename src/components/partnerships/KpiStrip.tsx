import {
  AlertTriangle, ArrowDownRight, ArrowUpRight, BadgeDollarSign, FileClock, Gift,
  Globe2, Handshake, MousePointerClick, RefreshCcw, ShoppingCart, TrendingUp, Users, Wallet,
} from 'lucide-react'
...
const ICONS = {
  users: Users, handshake: Handshake, cart: ShoppingCart, wallet: Wallet, dollar: BadgeDollarSign,
  trend: TrendingUp, alert: AlertTriangle, clock: FileClock, gift: Gift, globe: Globe2,
  refresh: RefreshCcw, click: MousePointerClick,
} as const
