...
/**
 * Shared Partnerships page header: breadcrumb → title → description → sub-nav.
    ...
    <header className="mb-4">
      <nav aria-label="Breadcrumb" className="mb-2">
        <ol className="flex items-center gap-1 text-xs text-slate-400">
          <li><Link href="/app/partnerships" className="transition-colors hover:text-slate-600">Partnerships</Link></li>
      ...
      <div className="mt-4">
        <PartnershipsSubNav modules={modules} />
      </div>
    </header>
  )
}
