...
/**
 * Shared public marketing footer. Every href here must resolve to a real
 * page — do not add a link without also shipping the page it points to.
 */
    ...
    <footer className="bg-slate-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-slate-400 text-sm">© {new Date().getFullYear()} Caption Fox Ltd. All rights reserved.</p>
