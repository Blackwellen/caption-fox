...
import {
  ArrowDownRight, ArrowUpRight, BadgeCheck, BadgePoundSterling, CalendarClock,
  CircleDollarSign, ClipboardList, Clock, FileCheck2, FileText, Gauge, Layers,
  PieChart, Receipt, RefreshCw, ShieldAlert, ShieldCheck, Star, Target,
...
const ICONS = {
  users: Users, file: FileText, clock: Clock, shieldCheck: ShieldCheck,
  shieldAlert: ShieldAlert, money: CircleDollarSign, target: Target, star: Star,
  layers: Layers, gauge: Gauge, pie: PieChart, trend: TrendingUp,
  calendar: CalendarClock, checks: FileCheck2, tasks: ClipboardList,
  wallet: Wallet, receipt: Receipt, refresh: RefreshCw, badge: BadgeCheck,
...
/**
 * Inline SVG sparkline. Rendered on the server with no chart library so the
 * KPI row costs nothing at hydration and never causes layout shift. Values are
 * a real daily series from the page's aggregates.
 */
...
/**
 * The KPI row shared by every Creators & UGC surface. Values are always
 * calculated from workspace-scoped data by the page; this component only
 * formats them.
 */
